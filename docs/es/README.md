*Read this in other languages: [English](../../README.md), [Español](README.md)*
...
- **🛡️ Bootstrapper Seguro:** Aprovisiona un servidor virgen en minutos. Instala Docker v27, inicializa Swarm, asegura tu servidor con UFW y fail2ban, y despliega Traefik v3 automáticamente.
...
* **Seguridad por Defecto:** Las bases de datos nunca se exponen al host público. Todos los contenedores usan `overlay networks` de Swarm, y el puerto público 80/443 está exclusivamente mediado por Traefik. Se bloquea login por contraseña en SSH y cuenta con Fail2Ban integrado.
